...
public class KeyValue implements Comparable<KeyValue> {
    ...
    public static KeyValue parseForm(byte[] bytes, int offset) throws IOException {
        if (bytes == null)
    ...
    public static KeyValue parseForm(byte[] bytes) throws IOException{
        return parseForm(bytes, 0);
    }
